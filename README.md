...
1. `gradlew clean`
2. `gradlew :backend:alfresco-authentication:classes`
3. `gradlew :backend:alfresco-authentication:jar`
4. `gradlew :backend:alfresco-authentication:sourcesJar`

The jar and sources.jar files can be found under [`backend/alfresco-authentication/build/libs/`](backend/alfresco-authentication/build/libs/). Copy these to your implementation project.
